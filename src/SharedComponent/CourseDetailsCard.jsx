...
const CourseDetailsCard = ({ course }) => {
    ...
    return (
        <div className='border-2 border-blue-600 mb-5 rounded-xl grid grid-cols-1 md:grid-cols-7 lg:grid-cols-6 gap-5 overflow-hidden'>
            ...
            <div className='md:col-span-4 lg:col-span-3 p-2'>
                ...
                <div className='flex justify-between items-center flex-col md:flex-row gap-3 my-2'>
                    <h1 className='text-2xl'><b>Price: </b><span className='text-pink-500 font-bold'>{course_fee} $</span></h1>
